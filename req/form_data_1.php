...
if($databaseHandler->verif==1){
    ...
    $databaseHandler->set_column_names("id_user_child");
    $databaseHandler->set_column_names("id_sha1_user_child");

    $databaseHandler->set_column_names("id_parent_user_child");
    $databaseHandler->set_column_names("description_user_child");
    $databaseHandler->set_column_names("title_user_child");
    $databaseHandler->set_column_names("img_user_child");



    $databaseHandler->set_column_names("nom_user_child");
    $databaseHandler->set_column_names("prenom_user_child");
    $databaseHandler->set_column_names("password_user_child");
    $databaseHandler->set_column_names("email_user_child");


    $databaseHandler->set_column_names("date_inscription_user_child");
    $databaseHandler->set_column_types("INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY");
    $databaseHandler->set_column_types("LONGTEXT NOT NULL");
    $databaseHandler->set_column_types("LONGTEXT NOT NULL");
